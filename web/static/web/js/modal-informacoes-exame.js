function initializeEventListeners() {
  ...
  function setDataModalInfoExam(patientData) {
    ...
    document.querySelector(
      "#patient-age"
    ).textContent = `${datasets.patientAge} anos`;
    document.querySelector("#patient-address").textContent =
      datasets.patientAddress;
    document.querySelector("#clinician-name").textContent =
      datasets.clinicianName;
    document.querySelector("#clinician-crm").textContent =
      datasets.clinicianCrm;
    ...
    document.querySelector("#modal-info-btn-show-images").dataset.examId =
      datasets.examId;
    document.querySelector("#modal-info-btn-show-images").dataset.resonanceId =
      datasets.resonance;
  }
