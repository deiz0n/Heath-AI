...
from .views import pagina_inicial, upload_raio_x, upload_ressonancia, upload_multi_modal, login, cadastro_usuario

urlpatterns = [
    path('', login, name='login'),
    path('pagina-inicial/', pagina_inicial, name='home'),
    path('cadastro-usuario/', cadastro_usuario,name='cadastro-usuario'),
